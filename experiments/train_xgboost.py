...
# Respeta el orden cronológico — no hay data leakage
# Split 1: Train [Año 1]     → Test [Año 2]
# Split 2: Train [Año 1-2]   → Test [Año 3]
# Split 3: Train [Año 1-2-3] → Test [Año 4]
# =========================
...
fold_df.to_csv("results/kfold_xgboost.csv", index=False)
print("\nResultados k-fold guardados en results/kfold_xgboost.csv")

# =========================
# MODELO FINAL
# Train: años 1-2-3 / Test: año 4 (igual que antes)
# Este es el modelo que se despliega en el prototipo
# =========================
...
with open("results/roc_xgboost.pkl", "wb") as f:
    pickle.dump({
        "fpr": fpr_curve,
        "tpr": tpr_curve,
        "auc": roc_auc
...
plt.xlabel("FPR")
plt.ylabel("TPR")
plt.title("ROC - XGBoost Temporal")
plt.legend()
plt.grid()
