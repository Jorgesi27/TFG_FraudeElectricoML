...
# =========================
# ESCALADO
# El scaler se ajusta sobre todo el dataset.
# =========================
scaler = StandardScaler()
X_scaled = scaler.fit_transform(X)

# =========================
# MODELO ARF — PREQUENTIAL
# =========================
...
# ROC
# =========================
with open("results/roc_arf.pkl", "wb") as f:
    pickle.dump({
        "fpr": fpr_curve,
        "tpr": tpr_curve,
        "auc": roc_auc
...
with open("models/arf_model.pkl", "wb") as f:
    pickle.dump(model, f)

with open("models/arf_scaler.pkl", "wb") as f:
    pickle.dump(scaler, f)

with open("models/arf_columns.pkl", "wb") as f:
    pickle.dump(columns, f)

print("\nModelo ARF guardado correctamente.")