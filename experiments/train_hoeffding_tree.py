...
# Escalado, es opcional para árboles, pero asi se mantiene coherencia con el resto de modelos
...
plt.figure()
plt.plot(fpr_curve, tpr_curve, label=f"Hoeffding Tree (AUC = {roc_auc:.3f})")
plt.plot([0, 1], [0, 1], linestyle='--')
plt.xlabel("False Positive Rate")
plt.ylabel("True Positive Rate (Recall)")
plt.title("Curva ROC - Hoeffding Tree")
plt.legend()
plt.grid()
