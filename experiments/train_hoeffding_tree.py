...
# =========================
# ESCALADO
# Hoeffding Tree no requiere escalado estrictamente, pero se aplica para mantener coherencia con el resto de modelos online
# =========================
scaler = StandardScaler()
X_scaled = scaler.fit_transform(X)

# =========================
# MODELO HOEFFDING TREE — PREQUENTIAL
# =========================
...
with open("results/roc_hoeffding_tree.pkl", "wb") as f:
    pickle.dump({
        "fpr": fpr_curve,
        "tpr": tpr_curve,
        "auc": roc_auc
...
plt.xlabel("FPR")
plt.ylabel("TPR")
plt.title("ROC - Hoeffding Tree")
plt.legend()
plt.grid()
plt.savefig("results/roc_hoeffding_tree.png", dpi=300)
plt.close()

# =========================
# OUTPUT
# =========================
print("\n===== RESULTADOS Hoeffding Tree =====")
