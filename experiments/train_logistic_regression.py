...
fold_df.to_csv("results/kfold_logistic_regression.csv", index=False)
print("\nResultados k-fold guardados en results/kfold_logistic_regression.csv")
...
plt.legend()
plt.grid()
plt.savefig("results/roc_logistic_regression.png", dpi=300)
plt.close()
