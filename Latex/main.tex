...
\begin{enumerate}[leftmargin=1.5cm]
    ...
    \item El operador selecciona la opción realizar predicción de fraude histórica.
    \item El sistema obtiene los datos asociados a la curva seleccionada.
    \item El sistema aplica el modelo predictivo \emph{online}.
    \item El sistema genera la clasificación de la curva.
    \item El sistema muestra el resultado de la predicción indicando si el consumo corresponde a un posible fraude o a un caso normal y la probabilidad asociada a la predicción realizada.
\end{enumerate}
\medskip
...
\begin{enumerate}[leftmargin=1.5cm]
    \item El operador selecciona un archivo de consumo previamente importado.
    \item El operador selecciona la opción consultar estadísticas.
    \item El sistema obtiene las curvas asociadas al archivo seleccionado.
    \item El sistema genera las estadísticas y carga las gráficas correspondientes.
...
3a-4a. Cancelar consulta de estadísticas.
\begin{enumerate}[leftmargin=1.5cm]
    \item El operador selecciona la opción salir mientras se realiza la carga de estadísticas.
    \item El sistema cancela la consulta y oculta las gráficas estadísticas.
\end{enumerate}
...
\section{Almacenamiento de ficheros}
